  ...
  return (
    <Box sx={{ width: 320, height: "100vh" }}>
      <Stack
        sx={{
          height: "100%",
          borderLeft: theme.palette.mode === "light" ? "" : "1px solid black",
      ...
      >
        ...
        <Box
          sx={{
            borderBottom:
              theme.palette.mode === "light" ? "" : "1px solid black",
            boxShadow: "0px 0px 2px rgba(0,0,0,0.25)",
            width: "100%",
            backgroundColor:
        ...
        >
          <Stack
            ...
            spacing={3}
          >
            <Typography variant="subtitle2">Contect Info</Typography>
            <IconButton
              onClick={() => {
        ...
        >
          ...
          >
            <Stack direction={"row"} alignItems={"center"} spacing={2}>
              <Star size={21} />
              <Typography variant="subtitle2">Starred Massages</Typography>
            </Stack>
          ...
          <Stack direction={"row"} spacing={2} alignItems={"center"}>
            ...
            <Stack spacing={0.5}>
              <Typography variant="subtitle2">NameOfGroup</Typography>
              <Typography variant="caprion">Owl,Parrot,Rabbit,You</Typography>
            </Stack>
          </Stack>
          <Stack direction={"row"} alignItems={"center"} spacing={2}>
            <Button
